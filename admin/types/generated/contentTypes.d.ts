...
export interface ApiCuponusadoCuponusado extends Struct.CollectionTypeSchema {
  collectionName: 'cuponusados';
  info: {
    displayName: 'cuponusado';
    pluralName: 'cuponusados';
    singularName: 'cuponusado';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    cliente_id: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cupon_id: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cuponusado.cuponusado'
    > &
      Schema.Attribute.Private;
    pedido_id: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    congrabado: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.Text;
    esnew: Schema.Attribute.Boolean;
    ...
    > &
      Schema.Attribute.Private;
    matecolor: Schema.Attribute.String;
    material: Schema.Attribute.Enumeration<
      ['CALABAZA', 'VIDRIO', 'METAL', 'MADERA']
    >;
    nombre: Schema.Attribute.String;
    precio: Schema.Attribute.BigInteger;
    publishedAt: Schema.Attribute.DateTime;
    stock: Schema.Attribute.Integer;
    tipocombo: Schema.Attribute.Enumeration<
      ['Ninguno', 'Mate + Bombilla', 'Mate + Bombilla + Portatermo']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    variantes: Schema.Attribute.Relation<
      ...
      'api::producto.producto'
    >;
    variantes_relacionadas: Schema.Attribute.Relation<
      'manyToMany',
      'api::producto.producto'
    >;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::cuponusado.cuponusado': ApiCuponusadoCuponusado;
